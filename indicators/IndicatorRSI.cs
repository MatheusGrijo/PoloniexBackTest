...
{
    public class IndicatorRSI : IIndicator
    {
        ...
        public Operation GetOperation(double[] arrayPriceOpen, double[] arrayPriceClose, double[] arrayPriceLow, double[] arrayPriceHigh, double[] arrayVolume)
        {
            try
            {
                ...
                TicTacTec.TA.Library.Core.Rsi(0, arrayPriceClose.Length - 1, arrayPriceClose, 20, out outBegidx, out outNbElement, arrayresultTA);
